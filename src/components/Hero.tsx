          ...
          <div className="flex justify-center gap-6">
            {[
              ...
              <a
                ...
                className="group relative p-4 rounded-xl bg-card/50 backdrop-blur-sm border border-border/50 hover:bg-card/70 hover:border-primary/30 transition-all duration-500 hover:scale-110 hover:-translate-y-2 hover:shadow-xl hover:shadow-primary/10"
