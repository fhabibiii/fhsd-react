          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                ...
                className="group px-6 py-3 bg-gradient-to-r from-primary to-primary/80 text-white dark:text-gray-900 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-lg font-semibold flex items-center justify-center gap-2 text-sm"
              >
                🚀 Lihat Paket Layanan
              ...
              <button
                ...
                className="px-6 py-3 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm border-2 border-primary/30 text-gray-900 dark:text-white rounded-xl hover:bg-primary/5 hover:border-primary/50 transition-all duration-300 font-semibold text-sm"
              >
                💬 Konsultasi Gratis
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-3">
              {[
                ...
                <div key={index} className="flex items-center gap-2 text-gray-700 dark:text-gray-300 text-xs">
                  <span>{guarantee}</span>
                </div>
              ))}
            </div>
            ...
            <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-xl p-4 border border-gray-200 dark:border-gray-700 shadow-lg">
              ...
              <div className="grid grid-cols-2 gap-2">
                {["🏢 Startup", "🏪 UKM", "🏬 Korporat", "🛒 E-Commerce"].map((type, index) => (
                  <div key={index} className="text-center py-1.5 px-2 bg-gradient-to-r from-gray-100 to-gray-50 dark:from-gray-700 dark:to-gray-800 rounded-lg">
