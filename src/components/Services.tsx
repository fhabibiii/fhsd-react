...
const Services = () => {
  ...
  const ServiceCard = ({ service, index }: { service: any; index: number }) => {
    ...
    return (
      <div
        ref={cardRef}
        className={`group relative bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden transition-all duration-700 hover:scale-105 hover:-translate-y-2 hover:shadow-xl hover:shadow-primary/10 transform ${
          cardVisible 
      ...
      >
        ...
        <div className="p-6">
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
            ...
            <button className={`w-full bg-gradient-to-r ${service.gradient} text-white px-4 py-3 rounded-xl transition-all duration-300 flex items-center justify-center gap-2 font-semibold hover:shadow-lg transform hover:scale-105 text-sm`}>
              Pilih Paket Ini
